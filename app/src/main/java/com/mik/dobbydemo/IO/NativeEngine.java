...
//            }
    ...
    public static String getRedirectedPath(String origPath) {
        try {
            ...
            CLogUtils.e("getRedirectedPath "+e.getMessage());
        }
        return origPath;
    }
    ...
    public static String resverseRedirectedPath(String origPath) {
        try {
            ...
            CLogUtils.e("resverseRedirectedPath "+e.getMessage());
        }
        return origPath;
    }
    ...
    public static void readOnlyFile(String path) {
        try {
            ...
            CLogUtils.e("readOnlyFile "+e.getMessage());
        }
    }
    ...
    public static void readOnly(String path) {
        ...
        try {
            ...
            CLogUtils.e("readOnly "+e.getMessage() + Log.getStackTraceString(e));
    ...
    public static void whitelistFile(String path) {
        try {
            ...
            CLogUtils.e("whitelistFile "+e.getMessage());
        }
    }
    ...
    public static void whitelist(String path) {
        ...
        try {
            ...
            CLogUtils.e("whitelist "+e.getMessage());
        }
    }
    ...
    public static void enableIORedirect(Context context) {
        ...
        for (Pair<String, String> pair : REDIRECT_LISTS) {
            try {
                //CLogUtils.e("启动之前:"+pair.first);
                //CLogUtils.e("启动之前:"+pair.second);
        ...
        try {
            ...
            CLogUtils.e("参数路径 soPath "+soPath);
            CLogUtils.e("参数路径 soPath64 "+soPath64);
            CLogUtils.e("参数路径 nativePath "+nativePath);

            nativeEnableIORedirect(soPath, soPath64, nativePath, Build.VERSION.SDK_INT, getPreviewSDKInt());

        } catch (Throwable e) {
            CLogUtils.e("enableIORedirect "+e.getMessage()+ Log.getStackTraceString(e));
        }
        sEnabled = true;
    }
    ...
    public static void bypassHiddenAPI(){
        if (BuildCompat.isPie()) {
            try {
                ...
                CLogUtils.e("bypassHiddenAPI error "+e.getMessage());
                e.printStackTrace();
            }
        }
    }
    ...
    public static void bypassHiddenAPIEnforcementPolicyIfNeeded() {
        ...
        //Q是10
        if (BuildCompat.isQ()) {
            //CLogUtils.e("开始执行 bypassHiddenAPI");
            bypassHiddenAPI();
    ...
    public static boolean onKillProcess(int pid, int signal) {
        CLogUtils.e( "killProcess: pid = %d, signal = %d." +pid+ "  "+  signal);
        if (pid == Process.myPid()) {
            CLogUtils.e(Log.getStackTraceString(new Throwable("killProcess == MySlef"+ Process.myPid())));
        }
        return true;
    }
...
//        getNativeCacheDir(VirtualCore.get().isPluginEngine()).getPath();
    ...
    public static int getPreviewSDKInt() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            try {
                //CLogUtils.e("getPreviewSDKInt 返回结果 " + Build.VERSION.PREVIEW_SDK_INT);
                return Build.VERSION.PREVIEW_SDK_INT;
            } catch (Throwable e) {
                // ignore
            }
        }
        CLogUtils.e("getPreviewSDKInt 返回结果 " + 0);
        return 0;
    }
